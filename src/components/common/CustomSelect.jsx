...
const CustomSelect = ({ options, placeholder, onChange }) => {
  ...
  return (
    <div className="relative text-gray-600">
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 z-50 w-full max-h-72 p-1 space-y-0.5 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto dark:bg-neutral-900 dark:border-neutral-700">
          {options.map((option) => (
            <div
              key={option.value}

        ...
        >
            <div className="w-full max-w-md bg-white py-6 px-8 rounded-lg shadow-lg">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={onClose} className="text-gray-800 hover:text-gray-900 focus:outline-none">
                        &times; {/* Close button */}
                    </button>
                </div>
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div className="login-btn mb-6">
                        <button
                            className={`w-full px-4 py-2 font-bold text-white rounded-full focus:outline-none focus:shadow-outline ${formData.username && formData.password ? "bg-blue-500 hover:bg-blue-600" : "bg-gray-400 cursor-not-allowed"}`}
                            type="submit"

                ...
                <form className="space-y-4">
                    ...
                    <div className="login-btn mb-6">
                        <button
                            ...
                            className={user && pwd ? "active w-full px-4 py-2 font-bold text-white rounded-full focus:outline-none focus:shadow-outline" : "w-full px-4 py-2 font-bold text-white rounded-full focus:outline-none focus:shadow-outline"}
                            type="button"
                ...
                <div className="space-y-4 text-gray-600 text-center">
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-xs">
                            ...
                            <Link to="/forgotpass" className="underline">Forgot password?</Link>
                        </p>
                        <p className="text-xs mt-2">

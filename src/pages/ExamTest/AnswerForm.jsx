...
const AnswerForm = ({
  ...
  const isListeningAndSectionType8 = skill === "Listening" && sectionType === 8;
  const isReadingAndValidSectionType =
    skill === "Reading" && [1, 2, 3].includes(sectionType);

  const showAddAnswerButton =
    isListeningAndSectionType8 || isReadingAndValidSectionType;

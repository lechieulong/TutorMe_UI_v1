                                            ...
                                            <div className="grid grid-cols-1 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="••••••"
                                                    />
                                                    {formErrors.currentPassword && <p className="font-mono text-red-500 text-xs mt-1">{formErrors.currentPassword}</p>}
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="••••••"
                                                    />
                                                    {formErrors.newpassword && <p className="font-mono text-red-500 text-xs mt-1">{formErrors.newpassword}</p>}
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        placeholder="••••••"
                                                    />
                                                    {formErrors.confirmPassword && <p className="font-mono text-red-500 text-xs mt-1">{formErrors.confirmPassword}</p>}
                                                </div>
                                            </div>
                                        </div>

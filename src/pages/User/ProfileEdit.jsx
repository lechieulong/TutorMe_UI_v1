                        ...
                        <div className="lg:col-span-3">
                            <div className="bg-white p-6 rounded-lg shadow-lg">
                                ...
                                <ul className="mt-6 flex space-x-4 border-b border-gray-300">
                                    <li>
                                        <a href="#" className="py-2 px-4 text-blue-600 border-b-2 border-blue-600">Profile Edit</a>
                                    </li>
                                </ul>
                                <div className="mt-6">
                                    <form noValidate>
                                        <div className="space-y-4">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500" type="text" placeholder="" defaultValue="" />
                                                </div>
                                                <div>
                                            ...
                                            <div>
                                                ...
                                                <input className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500" type="text" placeholder="" />
                                            </div>
                                            <div>
                                                <label className="block text-gray-700">About</label>
                                                <textarea className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500" rows="5" placeholder="My Bio"></textarea>
                                            </div>
